...
export default function ThemeToggle(){
 ...
 function toggle(){const next=!dark;setDark(next);document.documentElement.dataset.theme=next?'dark':'light';try{localStorage.setItem('samkov-theme',next?'dark':'light')}catch{}}
